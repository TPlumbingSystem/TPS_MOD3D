...
# TPS_MOD3D (identidade nova) -- roda de dentro de 4_GIT_TPS/mod3d/, mas os
# dados de origem continuam nas pastas originais do projeto (1_Modelo_3D_Taio,
# 2_Banco_de_Dados), so o caminho relativo muda pra sair daqui.
